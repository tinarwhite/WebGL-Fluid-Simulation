...
Real-time fluid dynamics running on the GPU. This is a simulation of the Navier-Stokes Equations with the assumption of an incompressible, homogeneous fluid. This is a modification of [WebGL-Fluid Simulation](https://github.com/PavelDoGreat/WebGL-Fluid-Simulation). Easily load images to make your own color palettes and fluid dynamic art.
